...
# Render/Host Compatibility: Launch with dynamic PORT & localhost bypass
if __name__ == "__main__":
    ...
    demo.launch(
        ...
        share=False,
        debug=False,
        root_path="/",  # Mount at root to bypass localhost/share force
        show_error=True  # Log errors without crash
    )
