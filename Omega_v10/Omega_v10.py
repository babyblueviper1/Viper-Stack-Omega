...
with gr.Blocks(
    ...
    <style>
      .qr-fab{position:fixed!important;right:20px!important;width:70px!important;height:70px!important;border-radius:50%!important;box-shadow:0 10px 40px rgba(0,0,0,0.7)!important;display:flex!important;align-items:center!important;justify-content:center!important;font-size:38px!important;cursor:pointer!important;transition:all 0.25s cubic-bezier(0.4,0,0.2,1)!important;border:5px solid white!important;font-weight:bold!important;user-select:none!important;z-index:9999!important;text-shadow:0 2px 8px rgba(0,0,0,0.5)!important}
