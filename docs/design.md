...
- Results are reproducible given the same inputs and fee context

This constrained scope is intentional and aims to **minimize CIOH amplification** while avoiding false certainty from inferred wallet structure.
...
This comparison allows users to reason about **“prune now vs later” regret**, expressed directly in sats, *before* constructing a PSBT.
...
Active experiment. Feedback welcome.
